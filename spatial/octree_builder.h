...
class octree_builder {
	...
	static constexpr uint8_t DEFAULT_MAX_DEPTH = 12;
	static constexpr uint32_t DEFAULT_INTERNAL_SAMPLES = 2048;
	static constexpr uint32_t MULTITHREAD_THRESHOLD = 10'000'000;
	...
	octree multithread_build(const float *x, const float *y, const float *z, uint32_t point_count, std::vector<uint32_t> &scratch,
