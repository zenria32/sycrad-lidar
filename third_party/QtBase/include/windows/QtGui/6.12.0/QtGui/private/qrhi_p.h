...
public:
    ...
    virtual void prepareDrawIndexedIndirect(QRhiCommandBuffer *cb,
                                            ...
                                            QRhiGraphicsPipeline::Topology topology, quint32 stride) = 0;
    virtual void executeDrawIndexedIndirect(QRhiCommandBuffer *cb) = 0;
