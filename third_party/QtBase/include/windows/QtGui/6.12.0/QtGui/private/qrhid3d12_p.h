...
public:
    ...
    void prepareDrawIndexedIndirect(QRhiCommandBuffer *cb,
                                    QRhiBuffer *argsBuffer, quint32 drawCount,
                                    QRhiBuffer *indexBuffer, quint32 indexOffset,
                                    QRhiCommandBuffer::IndexFormat indexFormat,
                                    QRhiGraphicsPipeline::Topology topology, quint32 stride) override;
    void executeDrawIndexedIndirect(QRhiCommandBuffer *cb) override;
    ...
    ID3D12CommandSignature *drawIndexedIndirectCmdSig = nullptr;
    quint32 drawIndexedIndirectCmdSigStride = 0;
    // pending indirect draw state (set in prepare, consumed in execute)
    QD3D12ObjectHandle pendingIndirectBufHandle;
    quint32 pendingIndirectDrawCount = 0;
    quint32 pendingIndirectStride = 0;
    bool pendingIndirectReady = false;
